...
def evaluate_model(model, test_loader, loss_fn, device):
    ...
    Returns:
        test_acc: Test accuracy in percentage.
    """
    model.eval()
    test_loss = 0
    correct = 0
...
def train_model():
    ...
    transforms.Resize((48, 48)),  # Resize to match input dimensions
    ...
    train_loader = get_dataloader(split='Training', fold=1, transform=transform, batch_size=batch_size)
        ...
        # For the test set, we don't apply augmentations, only resizing and normalization
