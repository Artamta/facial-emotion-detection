...
def custom_dataloader(split, batch_size, transform):
    dataset = CustomDataset(split=split, transform=transform)
    return DataLoader(dataset, batch_size=batch_size, shuffle=(split == 'Training'), num_workers=0)